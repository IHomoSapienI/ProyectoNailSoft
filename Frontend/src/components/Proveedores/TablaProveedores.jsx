        ...
        <table className="proveedores-tabla-moderna w-full">
          <thead className="bg-pink-200 text-black dark:card-gradient-4">
            <tr className="text-foreground">
              ...
              <th className="dark:bg-gray-500/50" style={{ width: "20%" }}>Nombre del Proveedor</th>
              <th className="dark:bg-gray-500/50" style={{ width: "20%" }}>Contacto</th>
              <th className="dark:bg-gray-500/50" style={{ width: "20%" }}>Número de Contacto</th>
              <th className="dark:bg-gray-500/50" style={{ width: "20%" }}>Estado</th>
              <th className="dark:bg-gray-500/50" style={{ width: "20%" }}>Acciones</th>
            </tr>
          </thead>
                ...
                <tr key={proveedor._id} className="text-foreground">
                  ...
                  <td>
                    ...
                    <div className="flex justify-center space-x-2">
                      <button className="btn-edit-1 dark:bg-indigo-900/50 dark:hover:bg-indigo-800/90" onClick={() => abrirFormulario(proveedor)} title="Editar proveedor">
                      ...
                      <button
                        className={`btn-toggle-1 dark:bg-amber-900/100 dark:hover:bg-amber-400/90 ${proveedor.estado ? "active" : "inactive"}`}
