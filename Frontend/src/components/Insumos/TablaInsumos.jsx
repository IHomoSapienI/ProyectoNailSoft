        ...
        <table className="insumos-tabla-moderna w-full">
          <thead className="bg-pink-200 text-black dark:card-gradient-4">
            <tr className="text-foreground">
              ...
              <th className="dark:bg-gray-500/50" style={{ width: "20%" }}>Nombre del Insumo</th>
              <th className="dark:bg-gray-500/50" style={{ width: "20%" }}>Stock</th>
              <th className="dark:bg-gray-500/50" style={{ width: "20%" }}>Precio</th>
                ...
                <tr key={insumo._id} className="text-foreground">
                  ...
                  <td>
                    ...
                    <div className="flex justify-center space-x-2">
                      <button className="btn-edit-1 dark:bg-indigo-900/50 dark:hover:bg-indigo-800/90" onClick={() => abrirFormulario(insumo)} title="Editar insumo">
                      ...
                      <button
                        className={`btn-toggle-1 dark:bg-amber-900/100 dark:hover:bg-amber-400/90 ${insumo.estado ? "active" : "inactive"}`}
