        ...
        <table className="categoria-tabla-moderna w-full">
          <thead className="bg-pink-200 text-black dark:card-gradient-4">
            <tr className="text-foreground">
              <th className="dark:bg-gray-500/50" style={{ width: "25%" }}>Nombre de la Categoría</th>
              <th className="dark:bg-gray-500/50" style={{ width: "25%" }}>Descripción</th>
              <th className="dark:bg-gray-500/50" style={{ width: "25%" }}>Estado</th>
              <th className="dark:bg-gray-500/50" style={{ width: "25%" }}>Acciones</th>
            </tr>
          </thead>
                ...
                <tr key={categoria._id} className="text-foreground">
                  ...
                  <td>
                    ...
                    <div className="flex justify-center space-x-2">
                      <button className="btn-edit-1 dark:bg-indigo-900/50 dark:hover:bg-indigo-800/90" onClick={() => manejarEditar(categoria)} title="Editar categoría">
